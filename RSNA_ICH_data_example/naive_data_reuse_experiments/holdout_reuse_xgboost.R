...
# for HPC:
setwd("/home/alexej.gossmann/ThresholdoutAUC/RSNA_ICH_data_example/naive_data_reuse_simulation")
...
tryCatch({
  results <- run_sim("xgbTree", iter_i, p,
                     RData_save_path = paste0(out_path, "naive_", iter_i, ".RData"),
                     nthread = num_cpus)
  write.csv(file = paste0(out_path, "naive_", iter_i, ".csv"), x = results)
}, error = function(e) {

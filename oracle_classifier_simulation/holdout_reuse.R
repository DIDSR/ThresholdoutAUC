...
# a function to fit classification models when the set of significant predictors is known
source("../functions/fit_single_model.R")
...
filename <- paste0("oracle_", array_task_id, ".csv")
out_path <- "/lustre/project/wyp/agossman/holdout_reuse/oracle_sim/"
